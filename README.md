...
### 2.4 Переменные окружения сайта проверки сервиса авторизации
...
В распоряжении сайта проверки авторизации находятся 9 ресурсов - это обычные API-функции, при успешной авторизации которые
...
параметра *Authorization*, содержащим токен, предварённый типом авторизационного токена - *Bearer*. Если параметра *Authorization*
